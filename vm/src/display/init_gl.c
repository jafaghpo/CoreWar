...
/*   Updated: 2018/02/13 16:30:11 by iburel           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void		init_vram(t_gl *gl)
{
	...
	glBufferData(GL_ARRAY_BUFFER, sizeof(tab) + sizeof(coord),
		0, GL_STATIC_DRAW);
...
int				init_gl(t_gl *gl)
{
	...
	glUniform3f(glGetUniformLocation(gl->prog, "color_text"),
	g_theme.color_texture.r, g_theme.color_texture.g, g_theme.color_texture.b);
	glUniform3f(glGetUniformLocation(gl->prog, "color_font"),
	g_theme.color_numbers.r, g_theme.color_numbers.g, g_theme.color_numbers.b);
