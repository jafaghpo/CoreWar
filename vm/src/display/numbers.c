...
/*   Updated: 2018/01/30 17:12:24 by iburel           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void init_vertices(float *vertices)
{
    ...
    vertices[8] = 0.5f;
    vertices[9] = 0.7f;
    vertices[10] = 0.5f + 16.f / (float)WIN_X * 7.f;
    vertices[11] = 0.7f;
    vertices[12] = 0.5f;
    vertices[13] = 0.7f + 17.f / (float)WIN_Y;
    vertices[14] = 0.5f + 16.f / (float)WIN_X * 7.f;
    vertices[15] = 0.7f + 17.f / (float)WIN_Y;
    vertices[16] = 0.8f;
    vertices[17] = 0.7f;
    vertices[18] = 0.8f + 16.f / (float)WIN_X * 5.f;
    vertices[19] = 0.7f;
    vertices[20] = 0.8f;
    vertices[21] = 0.7f + 17.f / (float)WIN_Y;
    vertices[22] = 0.8f + 16.f / (float)WIN_X * 5.f;
    vertices[23] = 0.7f + 17.f / (float)WIN_Y;
}
